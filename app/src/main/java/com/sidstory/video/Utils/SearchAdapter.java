...
public class SearchAdapter extends SearchSkeleton<VideoData,SearchAdapter.ViewHolder> {
    public SearchAdapter(final Context context, List<VideoData> data, final PullLoadMoreRecyclerView view, final IsCanSetAdapterListener isCanSetAdapterListener) {
        this.items=data;
        this.context=context;
        this.isCanSetAdapterListener=isCanSetAdapterListener;
        measureHeightRecyclerViewAndItem(view,R.layout.search_recycleview,2);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull final View itemView) {
            super(itemView);
            textView=itemView.findViewById(R.id.search_recycle_txt);
            imageView=itemView.findViewById(R.id.search_recycle_img);
            skeletonGroup=itemView.findViewById(R.id.search_skeletonGroup);
            time=itemView.findViewById(R.id.search_time);
            watch=itemView.findViewById(R.id.search_watch);
        }
    }
